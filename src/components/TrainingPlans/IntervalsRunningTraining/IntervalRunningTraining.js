        ...
        <div className="main__content training-plans" id="training-plans">
            { showTimer ?
                ...
                <>
                    ...
                    />
                    <h2 className="text__title">אימון הפוגות</h2>
                    ...
                    <section className='text__inforamtive-session'>
                        {
                            ...
                            <div>
                                <p className='text__description'>
                                    <b className='text__description_bold'>מה זה אימון הפוגות?</b><br/>
                                ...
                                <p className='text__description'>
                                    <b className='text__description_bold'>אימון הפוגות עצימות -</b> הוא אימון שמתאפיין בריצת מקטעים קצרים (בזמן או במרחק)
                                ...
                                <p className='text__description'>
                                    <b className='text__description_bold'>אימון הפוגות נרחבות -</b> הוא אימון שמתאפיין בריצת מקטעים ארוכים יותר ומטרתו היא לשפר את הסיבולת 
