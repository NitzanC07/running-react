                    ...
                    <h3 className='calculator__subtitle' onClick={changeShowTheory}>רקע תאורתי</h3>
                        {
                            ...
                            <div>
                                ...
                                <p className='calculator__text'>
                                    <b>אימון הפוגות עצימות</b> הוא אימון שמתאפיין בריצת מקטעים קצרים (בזמן או במרחק)
                                ...
                                <p className='calculator__text'>
                                    <b>אימון הפוגות נרחבות</b> הוא אימון שמתאפיין בריצת מקטעים ארוכים יותר ומטרתו היא לשפר את הסיבולת 
                                    ...
                                    בריצה שרוצים להתחיל לרוץ. גם באימונים אלה האימון יחלק את הריצה לשני פרקים עיקיים - ריצה עצימה
                                ...
                                <p className='calculator__text'>
                                    לרצים מתחילים מומלץ לתכנן אימוני הפוגות נרחבות שמורכבים מפרקי ריצה ופרקי הליכה. למשל להתחיל מפרקי
                                    ריצה של דקה אחת (ואפילו פחות), ופרקי התאוששות של בין דקה לשתי דקות. לחזור על האימון מספר פעמים
                                    ומאימון לאימון לשנות את המינונים של פרקי הזמן לטובת פרקי הריצה עד להגעה לריצה רצופה ושמירה על קצב רצוי.
                                    כמובן שעבור מתאמנים מתחילים לא הכרחי שפרקי הריצה יהיו עצימים מאוד או מעל הסף האנאירובי. בראש ובראשונה
                                    חשוב להקשיב לגוף.
                                </p>
